...
from figure_plot_d3d import plot_weekly_means_fuzzy_dates
...
parser.add_argument('--param-file', default='./parameters.json', help='Path to parameters.json')
parser.add_argument('--sobol-var', default=None, help='If set (e.g., NH4), print SOBOL_Y and exit')
...
# Y, matched_df = plot_weekly_means_fuzzy_dates(
#     simulated_data_dict={"NH4": np.array(NH4_all_zones)},
#     observe_file_path="./database/observe_data_20.xlsx",
#     delft_csv_dict=None,
#     hours_per_block=24*7,
...
# ============================================================
# Sobol metric: nutrient -> simulated data mapping
# ============================================================
SIMULATED_DICT_ALL = {
    "NH4": NH4_all_zones,
    "NO3": NO3_all_zones,
...
# ============================================================
# Sobol metric output (generic for all nutrients)
# ============================================================
if args.sobol_var is not None:

    sobol_var = args.sobol_var.upper()

    if sobol_var not in SIMULATED_DICT_ALL:
        raise ValueError(
            f"sobol-var={sobol_var} not supported. "
            f"Available: {list(SIMULATED_DICT_ALL.keys())}"
        )

    Y, matched_df = plot_weekly_means_fuzzy_dates(
        simulated_data_dict={
            sobol_var: np.array(SIMULATED_DICT_ALL[sobol_var])
        },
        observe_file_path="./database/observe_data_20.xlsx",
        delft_csv_dict=None,
        hours_per_block=24 * 7,
